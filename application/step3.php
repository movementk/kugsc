	...
	<div class="container">
		...
		<div class="form-wrap">
			<form action="#" method="post">
				<fieldset class="supporting-documents">
					<h4>7. Supporting Documents</h4>
					<p class="note text-right">* Required input</p>
					<table class="table">
					    <tr>
                            <th><span><i class="require"></i>Original academic transcript</span></th>
					        <td>
					    ...
					    <tr>
                            <th><span><i class="require"></i>Statement of purpose and goals(1 page)</span></th>
					        <td>
					            <div class="form-group">
					                <input type="text" class="form-control" required>
					                <p class="btn-search">
					    ...
					    <tr>
                            <th>
                                <span><i class="require"></i>Certificate of health</span>
                                <p class="btn-down">
                                    <a href="#" class="btn" role="button">click to download</a>
                                </p>
                            </th>
					        <td>
					            <div class="form-group">
					    ...
					    <tr>
                            <th>
                                <span><i class="require"></i>Oath of Good Conduct</span>
                                <p class="btn-down">
                                    <a href="#" class="btn" role="button">click to download</a>
                                </p>
                            </th>
                    ...
                    <div class="attention">
                        <ul>
                            <li> All the uploaded ?les should be shown dear enough to read.</li>
                            <li>
                                Copies of Documents may be accepted but must be certi?ed by staff of your home university with her/his name, title, and<br>
				...
				<fieldset class="declaration">
				    ...
				    <div class="detail-content">
                        ...
                        <ul>
                            ...
                            <li>Document issuance (Certificate of Admission, Transcript, Certificate of Enrollment)for exchange/visiting students</li>
